    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" id="formulario">
            ...
            <div class="modal-body">
                <form name="formCategoria" action="" method="POST" id="formCategoria">
                    <div class="form-group text-white">
                        <label for="inputCategoria">Categoria</label>
                        <input type="text" class="form-control" name="inputCategoria" id="inputCategoria" required placeholder="Hatch/SUV/Sedan...">
                    </div>
